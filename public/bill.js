...
function updateBill() {
	...
	for (
		var a = document.querySelectorAll("table.inventory tbody tr"), i = 0; a[i];
		++i
	) {
	...
	cells[2].innerHTML = document.querySelector(
		"table.balance tr:last-child td:last-child span:last-child"
	...
	for (
		a = document.querySelectorAll("span[data-prefix] + span"), i = 0; a[i];
		++i
	)
...
function onContentLoad() {
	...
	if (window.addEventListener) {
		...
		document.addEventListener("keydown", updateBill);
		document.addEventListener("keyup", updateBill);
